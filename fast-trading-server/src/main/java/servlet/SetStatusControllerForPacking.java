 ...
 */
public class SetStatusControllerForPacking extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		throws ServletException, IOException{
			...
			String[] setStatus = (String[])request.getParameterValues("setStatusForPacking");
			try {
				...
				String sql = "update order_record set packing_status = 'send' where oID = ?";
