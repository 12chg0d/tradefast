...
public class TableControllerForPacking extends HttpServlet{ 
		...
		throws ServletException,IOException{
			...
			try {
				...
				if(count>0){
					...
					session.setAttribute("tableForPacking", tb);
					response.sendRedirect("pack_changestat");
				} else {
					String haveTableForPacking = "no";
					//In case you don't care about the URL and throwing object, you can use RequestDispatcher. It is better performance than using sendRedirect.
				   	session.setAttribute("haveTableForPacking", haveTableForPacking);
